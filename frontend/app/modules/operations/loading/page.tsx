  ...
  const [operations] = useState<LoadingOperation[]>([
    {
      id: 1,
      trip_id: 101,
      warehouse_name: "Makati Distribution Center",
      ...
      vehicle: "Volvo FH16 (Plate: NFR 2048)",
    },
    {
      id: 2,
      trip_id: 102,
      warehouse_name: "Clark Freight Terminal",
      operation_type: "loading",
      ...
      status: "in-progress",
      driver: "James Cooper",
      vehicle: "Scania R440 (Plate: NFR 3015)",
    },
    {
      id: 3,
      trip_id: 103,
      warehouse_name: "Laguna Logistics Warehouse",
