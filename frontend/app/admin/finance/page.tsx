      ...
      <div className="container" style={{ maxWidth: "1000px", margin: "0 auto", display: "grid", gap: "1.2rem" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(220px, 1fr))", gap: "1rem" }}>
          <div style={{ background: "white", border: "1px solid #E8E8E8", borderRadius: "10px", padding: "1rem" }}>
            ...
            <p style={{ margin: 0, fontSize: "1.8rem", fontWeight: 900, color: "#10B981" }}>${kpis.totalRevenue.toFixed(2)}</p>
          </div>
          <div style={{ background: "white", border: "1px solid #E8E8E8", borderRadius: "10px", padding: "1rem" }}>
            <p style={{ margin: "0 0 0.35rem", color: "#666", fontSize: "0.85rem" }}>Fuel Costs</p>
            <p style={{ margin: 0, fontSize: "1.8rem", fontWeight: 900, color: "#F59E0B" }}>${kpis.totalFuel.toFixed(2)}</p>
          </div>
          <div style={{ background: "white", border: "1px solid #E8E8E8", borderRadius: "10px", padding: "1rem" }}>
            <p style={{ margin: "0 0 0.35rem", color: "#666", fontSize: "0.85rem" }}>Toll Fees</p>
            <p style={{ margin: 0, fontSize: "1.8rem", fontWeight: 900, color: "#3B82F6" }}>${kpis.totalToll.toFixed(2)}</p>
          </div>
        </div>
        ...
        <section style={{ background: "white", border: "1px solid #E8E8E8", borderRadius: "10px", padding: "1rem" }}>
          ...
          <p style={{ margin: "0 0 0.35rem", color: "#666" }}>Net after fuel+toll (mock): ${(kpis.totalRevenue - (kpis.totalFuel + kpis.totalToll)).toFixed(2)}</p>
