...
CHECKS: list[tuple[str, str, str, set[int], str]] = [
    ...
    ("admin", "GET", "/api/reports/bookings.csv", {200}, "bookings csv"),
    ("admin", "GET", "/api/reports/fleet.csv", {200}, "fleet csv"),
    ("manager", "GET", "/api/manager/dashboard", {200, 404}, "manager dashboard"),
    ("manager", "GET", "/api/manager/finance.csv", {200}, "finance csv"),
    ("manager", "GET", "/api/manager/maintenance.csv", {200}, "maintenance csv"),
